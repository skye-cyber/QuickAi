...
function initChat(client) {
    ...
    async function classifyText(text) {
        ...
        if (isImageRequest) {
            ...
            <div id="${imageId}" class="w-fit bg-gray-200 text-gray-800 dark:bg-gradient-to-tl dark:from-teal-700 dark:to-cyan-700 dark:text-gray-100 rounded-lg p-2 font-normal shadow-lg dark:shadow-blue-500 max-w-3xl mb-8">
            ...
            aiMessage.classList.add(aiMessageUId, "flex", "justify-start", "mb-12");
