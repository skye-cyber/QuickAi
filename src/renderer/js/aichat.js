...
function initChat(client) {
    ...
    renderer.code = function (code, language) {
        ...
        return `
        <div class="relative my-auto p-2 border border-gray-300 dark:border-gray-900 bg-white dark:bg-gray-800 rounded-md w-fit max-w-full lg:max-w-6xl">
    ...
    async function classifyText(text) {
        ...
        if (isImageRequest) {
            ...
            aiMessage.classList.add("flex", "justify-start", "mb-[6%]");
