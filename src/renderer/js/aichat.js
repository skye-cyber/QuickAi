                ...
                for await (const chunk of stream) {
                    ...
                    if (choice?.delta?.content) {
                        ...
                        <section class="relative">
                            <div class="${aiMessageUId} bg-gray-200 text-gray-800 dark:bg-gradient-to-tl dark:from-blue-500 dark:to-sky-500 dark:text-black rounded-lg p-2 shadow-lg dark:shadow-blue-500 p-3 w-fit max-w-full lg:max-w-6xl">${marked(output)}
                            </div>

                            <div class="absolute bottom-0 left-0 opacity-50 hover:opacity-100 border-none z-60" id="exportButton" onclick="toggleExportOptions(this);">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 5a2 2 0 100 4 2 2 0 000-4zm0 8v.01M12 13a2 2 0 100 4 2 2 0 000-4zm0-8a2 2 0 100 4 2 2 0 000-4z" />
                                </svg>
                                </div>

                                <div id="exportOptions" class="hidden block absolute bottom-0 left-0 bg-white dark:bg-gray-800 p-2 rounded shadow-md z-50">
                                <ul class="list-none p-0">
                                    <li class="mb-2">
                                        <a href=""  class="text-blue-500 dark:text-blue-400" onclick="HTML2Pdf(event, '.${aiMessageUId}')">1. Export to PDF</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href=""  class="text-blue-500 dark:text-blue-400" onclick="HTML2Png(event, '.${aiMessageUId}')">2. Export to PNG</a>
                                    </li>
                                    <li>
