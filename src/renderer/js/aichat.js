...
function initChat(client) {
    ...
    renderer.code = function (code, language) {
        ...
        return `
        <div class="relative my-auto p-2 border border-gray-900 bg-white dark:bg-gray-800 rounded-md">
    ...
    async function classifyText(text) {
        ...
        if (isImageRequest) {
            ...
            <div id="${imageId}" class="w-fit bg-gray-200 text-gray-800 dark:bg-gradient-to-tl dark:from-teal-700 dark:to-cyan-700 dark:text-gray-100 rounded-lg p-2 font-normal shadow-lg dark:shadow-blue-500 max-w-3xl mb-[5%]">
            ...
            if (imageUrl) {
                ...
                imageContainer.classList.add("mb-[5%]")
            ...
            aiMessage.classList.add(aiMessageUId, "flex", "justify-start", "mb-[5%]");
